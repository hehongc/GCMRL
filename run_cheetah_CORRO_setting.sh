#!/bin/bash
 ...
 do
 OMP_NUM_THREADS=16 KMP_AFFINITY="compact,granularity\=fine" CUDA_VISIBLE_DEVICES=${n} nohup python launch_experiment_${algo}.py \
 ./configs/cpearl-cheetah-vel-1.json \
 /home/data/cheetah-vel \
 --gpu=${n} \
